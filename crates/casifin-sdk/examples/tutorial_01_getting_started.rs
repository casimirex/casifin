...
fn main() -> Result<(), CasifinError> {
    ...
    let pv = casifin.pv(
        Decimal::new(7, 2),     // 7% annual return
        30,                     // 30 years
    ...
    let monthly_rate = Decimal::new(7, 2) / Decimal::from(12);
    let months = 30 * 12;
    let pmt = casifin.pmt(
        monthly_rate,
        months,
